...
WHAT'S INSIDE
------------------------------------------------------------------------
One cohesive Rustic building kit — every prop shares the same palette and
...
------------------------------------------------------------------------
  production-ready/
    FBX/   Every piece as .fbx (Y-up) + Rustic_FullBuild.fbx (the whole kit).
           Best for Unity and Maya/Max pipelines.
    GLB/   Every piece as .glb (Y-up, materials embedded) + Rustic_FullBuild.glb.
           Drop-in for Godot, Three.js, Babylon, Unreal (glTF), Sketchfab.
    Rustic_FullBuild.blend
...
TECH SPECS
------------------------------------------------------------------------
  Style               Rustic  (pack 01 of the Jampot series)
