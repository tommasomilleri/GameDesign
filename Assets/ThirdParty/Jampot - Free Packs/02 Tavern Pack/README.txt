...
WHAT'S INSIDE
------------------------------------------------------------------------
One cohesive Tavern building kit — every prop shares the same palette and
...
------------------------------------------------------------------------
  production-ready/
    FBX/   Every piece as .fbx (Y-up) + Tavern_FullBuild.fbx (the whole kit).
           Best for Unity and Maya/Max pipelines.
    GLB/   Every piece as .glb (Y-up, materials embedded) + Tavern_FullBuild.glb.
           Drop-in for Godot, Three.js, Babylon, Unreal (glTF), Sketchfab.
    Tavern_FullBuild.blend
...
TECH SPECS
------------------------------------------------------------------------
  Style               Tavern  (pack 02 of the Jampot series)
