...
public static class Stats_Fante
{
    ...
    public static float START_MOVEMENT_SPEED = 5f;
    public static int START_MONEY = 0;
    public static float START_RANGE = 2.5f;
    public static int START_ATTACK_SPEED = 50;
    public static int START_RELOAD_TIME = 50;
}

public static class Stats_Cavallo
{
    public static int START_LIFE = 150;
    public static int START_ATTACK = 25;
    public static int START_DEFENSE = 8;
    public static float START_MOVEMENT_SPEED = 8.5f;
    public static int START_MONEY = 3;
...
public static class Stats_Re
{
    ...
    public static float START_MOVEMENT_SPEED = 3.5f;
